  ...
  try {
    ...
    const trade = await prisma.trade.create({
      data: {
        ...
        meditationPractice: validatedData.meditationPractice,
        internetIssues: validatedData.internetIssues,
        stressLevel: validatedData.stressLevel,
        energyLevel: validatedData.energyLevel,
        focusLevel: validatedData.focusLevel,
        marketSentiment: validatedData.marketSentiment,
        newsImpact: validatedData.newsImpact,
        socialMediaInfluence: validatedData.socialMediaInfluence,
        fomoLevel: validatedData.fomoLevel,
        revengeTrading: validatedData.revengeTrading,
        impulsiveTrading: validatedData.impulsiveTrading,
        overconfidence: validatedData.overconfidence,
        analysisTime: validatedData.analysisTime,
        decisionTime: validatedData.decisionTime,
        preTradeMood: validatedData.preTradeMood,
        postTradeMood: validatedData.postTradeMood,
        learningFromMistakes: validatedData.learningFromMistakes,
        strategyDeviation: validatedData.strategyDeviation,
        emotionalTriggers: validatedData.emotionalTriggers,
        copingMechanisms: validatedData.copingMechanisms,
        charges: {
          create: [
            {
